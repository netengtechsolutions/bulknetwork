...
while ($hosts -eq '') {
	...
	3) $HQ = "10.1.20.254","10.1.21.254","10.1.25.254","10.1.50.254","10.1.150.254","2620:fc:0:d358:50::50","2620:fc:0:d358:100:d115:dc97:313b","2620:fc:0:d358:150::150"
    4) $HQ_IPv6 = "2620:fc:0:d358:50::50","2620:fc:0:d358:100:d115:dc97:313b","2620:fc:0:d358:150::150" 
    5) $MP_IPv6 = "2620:fc:0:d369:50::50","2620:fc:0:d369:100::1","2620:fc:0:d369:150::150"
	6) $MP = "10.2.20.254","10.2.21.254","10.2.25.254","10.2.50.254","10.2.125.254","10.2.150.254","2620:fc:0:d369:50::50","2620:fc:0:d369:100::1","2620:fc:0:d369:150::150"
    '
    if ($selection -eq 1) { $hosts = $HQ_IPv4 }
    elseif ($selection -eq 2) { $hosts = $MP_IPv4 }
    elseif ($selection -eq 3) { $hosts = $HQ }
    elseif ($selection -eq 4) { $hosts = $HQ_IPv6 }
	elseif ($selection -eq 5) { $hosts = $MP_IPv4 }
	elseif ($selection -eq 6) { $hosts = $MP }
}
